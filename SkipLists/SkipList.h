...
public:
    ...
    void build_up_rand(Node* node, vector<vector<Node*>> &last_nodes){
        Node* node_traverse = node;
        vector<Node*> upper_nodes;
        Node* node_prev; // used for connecting nodes horizontally
        int counter = 0;
    ...
    Node* find_element_rec(int value, Node* head_copy){
        ...
        Node* des_node = find_element_rec(value, head_copy -> down);
        return des_node;
    }
    ...
    vector<Node*> find_closest_element_rec(int value, Node* head_copy){
        ...
        vector<Node*> closest_elements  = find_closest_element_rec(value, head_copy -> down);
    ...
    Node* find_element(int value){
        ...
        */
        ...
        Node* node = SkipList::find_element_rec(value, head_copy);
        if (node == NULL){
            return node;
        } else {
    ...
    vector<Node*> find_closest_elements(int value){
        ...
        */
        ...
        vector<Node*> nodes = SkipList::find_closest_element_rec(value, head_copy);
    ...
    void insert_element_min_max(int value, bool is_max, Node* node){
        ...
        Node* start = new Node; // maintain pointer to the start of the new ll
        Node* traverse_node = start; // for traversing and adding nodes to the new ll
        Node* node_copy = node; // copy of the head or tail of skip list
    ...
    void remove_element_min_max(Node* node_to_remove, bool is_max){
        ...
        if (is_max){
            // connect level 0
            Node* node_to_remove_copy = node_to_remove -> up;
            Node* node_prev = node_to_remove -> prev;            
            ...
            Node* node_to_remove_copy_traverse = node_to_remove_copy; // copy for traversal
            ...
            // connect level 0
            Node* node_to_remove_copy = node_to_remove -> up;
            Node* node_next = node_to_remove -> next;
    ...
    void remove_element(int value){
        Node* node_to_be_removed = find_element(value);
        ...
        while (node_to_be_removed != NULL){
            Node* node_to_be_removed_traverse = node_to_be_removed; // make a copy for traversal
    ...
    void insert_element(int value){
        ...
        vector<Node*> nodes = find_closest_elements(value);
        ...
        while (rand() % 2 && insert_height <= this -> MAX_LVL){
            ...
            Node* start_copy_left = start;
            Node* start_copy_right = start;
            Node* insert_node_up = new Node;
